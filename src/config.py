...
TRELLO_API_KEY = getKey("TRELLO_API_KEY")
TRELLO_API_SECRET = getKey("TRELLO_API_SECRET")
TRELLO_BOARD_ID = getKey("TRELLO_BOARD_ID")
ROOT_WEBHOOK_URL = getKey("ROOT_WEBHOOK_URL")
